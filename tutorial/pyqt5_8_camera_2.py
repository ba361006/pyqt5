...
class MainWindow(QMainWindow): 
    ...
    def __init__(self): 
        ...
        # initialize statusbar on mainWindow
    ...
    def __cameraSetting(self):
        ...
        # initialize cameraViewFinder
        self.__initCameraViewFinder()
  
        # Set the default camera. 
        self.select_camera(0) 


    def __initCameraViewFinder(self):
    ...
    def __toolBar(self):
        ...
        # initialize action 
        click_photo_action = self.__clickPhotoAction()
        change_folder_action = self.__changeFolderAction()
    
        # initalize widget
        camera_selector = self.__cameraSelector()

        # adding these to the tool bar 
        toolbar.addAction(click_photo_action) 
    ...
    def __clickPhotoAction(self):
        # creating a photo action to take photo 
        click_action = QAction("Click photo", self) 
  
        # adding status tip to the photo action
        # this would show the text at the bottom of the mainWindow once 
        # you put the mouse on the the button which QAction connects to
    ...
    def __changeFolderAction(self):
        ...
        return change_folder_action

    def __cameraSelector(self):
